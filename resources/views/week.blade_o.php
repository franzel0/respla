        ...
        <div class="col-md-12 padding5">
            <div class="panel panel-default">
                	...
                	<nav class="navbar navbar-default">
                		<div class="container-fluid">
    						...
    						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                				...
                				{!!Form::open(['action' => 'EventController@showWeek', 'method' => 'post', 'class' => 'navbar-form navbar-left', 'role' => 'search', '	style' => 	'display: inline'])!!}
            	...
            	<div ID="week-panel" class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <table class="table table-bordered table-data">
                                        <tr>
                                            <th>
                                            @if(in_array($day->toDateString(), $comments->lists('date')->toArray()))
                                                {{$comments->get(array_search($day->toDateString(), $comments->lists('date')->toArray()))->text}}
                                            @endif
                                            </th>
                                        </tr>
                                    </table>
                    ...
                    <div class="row well well-sm">
                        <h3>Anwesend</h3>
                        <div id=" present" class="col-md-12 col-sm-12 col-xs-12  col-sm-12 col-xs-12 week-overflow">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                </div>
                                <?php
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <table class="table table-bordered table-data ">
                                        @foreach ($events[$day->toDateString()] as $e)
                                            @if($e->entrypresent==1 && $day->isweekday() && !in_array($day->toDateString(), $customdates))
                                            <tr>
                                                <td class="{{$e->class}} {{$e->class2}}">{{$e->fullname}}</td>
                                            </tr>
                                            <?php
                                            $count++;
                                            ?>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12  week-overflow">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <table class="table table-bordered table-data">
                                        @foreach ($events[$day->toDateString()] as $e)
                                            @if($e->entrypresent==0 && $day->isweekday() && !in_array($day->toDateString(), $customdates))
                                            <tr>
                                                <td class="{{$e['class']}} {{$e['class2']}}">{{$e->fullname}}</td>
                                            </tr>
                                            <?php
