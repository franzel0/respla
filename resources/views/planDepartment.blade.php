                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbar-form-details">
                                {!! Form::open(['action' => 'PlanController@indexDepartment', 'method' => 'post', 'class' => 'navbar-form navbar-left panel-body-navbar-form', 'role' => 'search']) !!}
                                    ...
                                    <div class="input-group ">
                                        {!! Form::submit("Freigeben", ['class' => 'btn btn-success']) !!}
                                    </div>
